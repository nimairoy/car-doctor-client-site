...
const Banner = () => {
    const bannerText = <>
        ...
        <div className='absolute bg-gradient-to-r rounded-xl from-[#151515] to-[rgba(21, 21, 21, 0)] top-0 bottom-0 left-0 right-0'>
    ...
    return (
        <div className="carousel w-full h-screen mt-4">
            ...
            <div id="slide3" className="carousel-item relative w-full">
                ...
                <div className="absolute flex justify-end transform -translate-y-1/2  right-5 bottom-0">
                    <a href="#slide2" className="btn bg-red-500 btn-circle mr-5">❮</a>
            ...
            <div id="slide4" className="carousel-item relative w-full">
                ...
                <div className="absolute flex justify-end transform -translate-y-1/2  right-5 bottom-0">
                    ...
                    <a href="#slide5" className="btn bg-red-500 btn-circle">❯</a>
                </div>
            </div>
            <div id="slide5" className="carousel-item relative w-full">
                ...
                <div className="absolute flex justify-end transform -translate-y-1/2  right-5 bottom-0">
                    <a href="#slide4" className="btn bg-red-500 btn-circle mr-5">❮</a>
                    <a href="#slide6" className="btn bg-red-500 btn-circle">❯</a>
                </div>
            </div>
            <div id="slide6" className="carousel-item relative w-full">
                ...
                <div className="absolute flex justify-end transform -translate-y-1/2  right-5 bottom-0">
                    <a href="#slide5" className="btn bg-red-500 btn-circle mr-5">❮</a>
